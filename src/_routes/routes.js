...
const ManageRequisition = React.lazy(() =>
  import("../PostLogin/Requisition/ManageRequisition")
);
const RequisitionTracker = React.lazy(() =>
  import("../PostLogin/Requisition/RequisitionTracker")
);
const NewRequisition = React.lazy(() =>
  import("../PostLogin/Requisition/NewRequisition")
);
const ApprovedRequisition = React.lazy(() =>
  import("../PostLogin/Requisition/ApprovedRequisition")
);
const ViewRequisition = React.lazy(() =>
  import("../PostLogin/Requisition/ViewRequisition")
);
...
const AddNewContact = React.lazy(() =>
  import("../PostLogin/Contact/AddNewContact")
);
...
const ViewInvoice = React.lazy(() =>
  import("../PostLogin/Invoices/ViewInvoice")
);
const CreateInvoice = React.lazy(() =>
  import("../PostLogin/Invoices/CreateInvoice")
);
const Calender = React.lazy(() => import("../PostLogin/Calender"));
const selectCommitteeMember = React.lazy(() =>
  import("../PostLogin/SetUpCommittee/SelectCommitteeMember")
);
const ViewRecievedRfp = React.lazy(() =>
  import("../PostLogin/RecievedRfp/ViewRecievedRfp")
);
const TrackRfp = React.lazy(() => import("../PostLogin/RecievedRfp/TrackRfp"));
const ViewRecievedRfq = React.lazy(() =>
  import("../PostLogin/RecievedRfq/ViewRecievedRfq")
);
// const ViewPurchaseOrder = React.lazy(() => import('../PostLogin/GeneratePo/viewPo'));
const AddInvoices = React.lazy(() =>
  import("../PostLogin/Invoices/AddNewInvoice")
);
const PurcahseOrder = React.lazy(() =>
  import("../PostLogin/GeneratePo/PurchaseOrder")
);
const ViewPurchaseOrder = React.lazy(() =>
  import("../PostLogin/GeneratePo/ViewPurchaseOrder")
);
const CreatePurchaseOrder = React.lazy(() =>
  import("../PostLogin/GeneratePo/CreatePurchaseOrder")
);
const CreateInvoicePurchaseOrder = React.lazy(() =>
  import("../PostLogin/Invoices/CreateInvoicePurchaseOrder")
);
const BudgetOverview = React.lazy(() => import("../PostLogin/BudgetOverview"));
const Reports = React.lazy(() => import("../PostLogin/Reports"));
const ApprovePurchaseOrder = React.lazy(() =>
  import("../PostLogin/GeneratePo/ApprovePo")
);
const BudgetAllocate = React.lazy(() =>
  import("../PostLogin/BudgetOverview/AllocatedBudget")
);
const BudgetAllocation = React.lazy(() =>
  import("../PostLogin/BudgetOverview/BudgetAllocation")
);
const VendorQuotation = React.lazy(() =>
  import("../PostLogin/VendorQuatation")
);
...
const RequestForPurpose = React.lazy(() =>
  import("../PostLogin/RequestForPurpose")
);
const CreateNewRequest = React.lazy(() =>
  import("../PostLogin/RequestForPurpose/CreateNewRequest")
);
const ViewRequest = React.lazy(() =>
  import("../PostLogin/RequestForPurpose/ViewRequests")
);
const PurchaseRequisition = React.lazy(() =>
  import("../PostLogin/Requisition/PurchaseRequisition")
);
const PurchaseRequisitionDetail = React.lazy(() =>
  import(
    "../PostLogin/Requisition/PurchaseRequisition/PurchaseRequisitionDetail"
  )
);
const ActiveProductCatalogue = React.lazy(() =>
  import("../PostLogin/ManageSupplier/ActiveProductCatalogue")
);
const AddSupplier = React.lazy(() =>
  import("../PostLogin/ManageSupplier/AddSupplier")
);
const CreatChatRooms = React.lazy(() =>
  import("../PostLogin/ChatRoom/CreateChatRoom")
);
const ManageSupplier = React.lazy(() =>
  import("../PostLogin/ManageSupplier/index")
);
const ActiveSuppliers = React.lazy(() =>
  import("../PostLogin/ManageSupplier/ActiveSupplier")
);
const ViewSupplierDetail = React.lazy(() =>
  import("../PostLogin/ManageSupplier/ViewSupplierDetail")
);
const AddProduct = React.lazy(() =>
  import("../PostLogin/ManageSupplier/AddProduct")
);
...
const ViewDetails = React.lazy(() =>
  import("../PostLogin/Request/ViewDetails")
);
const viewRequest = React.lazy(() =>
  import("../PostLogin/Request/ViewRequest")
);
...
const AddProducts = React.lazy(() =>
  import("../PostLogin/Products/AddProducts")
);
const RequestForQuotation = React.lazy(() =>
  import("../PostLogin/RequestForQuotation")
);
const CreateRfq = React.lazy(() =>
  import("../PostLogin/RequestForQuotation/CreateRfq")
);
const RfqDetails = React.lazy(() =>
  import("../PostLogin/RequestForQuotation/RfqDetails")
);
...
const routes = [
  ...
  {
    path: "/postlogin/GeneratePo/Createpurchaseorder/:id",
    exact: true,
