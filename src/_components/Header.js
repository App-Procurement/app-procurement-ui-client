            ...
            <div className="row justify-content-center align-items-center">
              ...
              <div className="col-xl-8 col-12">
                <div className="d-block text-right header-notification">
                  <div className="d-none d-xl-inline-block menu">
                    <a href="#foo">{t("other menus")}</a>
                  </div>
                  <div className="notification-list">
                    <Badge
                      onClick={this.openSearchToggle}
                    ...
                    <Badge
                      onClick={this.openNotificationModel}
                      badgeContent={5}
                    ...
                    <Badge
                      badgeContent={3}
                      className="d-none d-md-inline-block noti-icon"
                    >
                      <FolderIcon />
                    </Badge>
                  </div>
                  <div
                    className="country-menu border-right"
                    ...
                    <ul>
                      ...
                      <li>
                        <span
                          ...
                          onClick={this.openLogOutModel}
                        >
                          <strong>Franklin Jr.</strong> <br></br>Super Admin
                        </span>
                      </li>
                      ...
                      <>
                        ...
                        <div className="profile-menu">
                          <ul>
                            ...
                            <li>
                              <SportsSoccerIcon className="menu-icon" />
                              Support
                            </li>
                            <li>
                              <LockOutlinedIcon className="menu-icon" />
                              Lock
                            </li>
                            <li>
