			...
			retData.push(
				<li className="sidebar-menu" key={nav.name} onClick={this.handelSideNav}>
					...
					>
						...
						{nav.name === 'Email' &&
						emailLength > 0 && <span className="float-right length">{emailLength}</span>}
					</ListItem>
					{nav.children && (
				...
				<div className={isOpen ? 'sidebar open' : 'sidebar'}>
					...
					<SimpleBar style={{ maxHeight: 'calc(100% - 76px)' }}>
						<List className="sidebar-content">
							<ListItem className="menu-heading">Main Menu</ListItem>
							{this.displaySidebarMenu()}
						</List>
						<List className="sidebar-content">
							<ListItem className="menu-heading">Support</ListItem>
							<li className="sidebar-menu" key={'setting'} onClick={this.handelSideNav}>
								<ListItem tabIndex="0" component={Link} to={'/postlogin/setting'}>
									<ListItemIcon className="icon">
										<i className="fab fa-microsoft" />
									</ListItemIcon>
									<ListItemText primary="Setting" className="name" />
								</ListItem>
							</li>
							<li className="sidebar-menu" key={'help'} onClick={this.handelSideNav}>
								<ListItem tabIndex="0" component={Link}>
									<ListItemIcon className="icon">
										<i className="fab fa-microsoft" />
									</ListItemIcon>
									<ListItemText primary="Help" className="name" />
								</ListItem>
							</li>
						</List>
