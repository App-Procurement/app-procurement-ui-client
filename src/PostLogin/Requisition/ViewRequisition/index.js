...
class ViewRequisition extends Component {
	...
	componentDidUpdate(prevProps, prevState) {
		...
		if (
			prevProps.get_edit_requisition_status !== this.props.get_edit_requisition_status &&
			...
			if (editRequisitiondata) {
				...
				requisitionData.extraBudgetoryFile = editRequisitiondata.extraBudgetoryFile;
	...
	displayTableData = () => {
		const { requisitionData } = this.state;
		let retData = [];
		if (requisitionData.lineItemList && requisitionData.lineItemList.length > 0) {
				...
				<div className="approved-content">
					<div className="recieved-content">
							...
							<div className="heading-content">
								<div className="row align-items-end">
									<div className="col-xl-6 col-lg-6 col-md-8 col-sm-6 col-12">
										...
										<Button variant="contained" className="pending-btn recieved-btn">
											Recieved
										</Button>
									</div>
									<div className="col-xl-6 col-lg-6 col-md-4 col-sm-6 col-12">
										<div className="creation-box">
											...
											{requisitionData &&
											requisitionData.createdOn && <span>{requisitionData.createdOn}</span>}
										</div>
									</div>
								</div>
							</div>
						...
						<div className="recieved-button">
							...
							{buyersListTable.data &&
							buyersListTable.data.length > 0 && (
								<Button onClick={this.setSelectedBuyers} variant="contained" className="primary-btn">
									<a href="#foo">Send</a>
								</Button>
							)}
						</div>
