...
class ViewRequisition extends Component {
  ...
  updateSelectedBuyers = () => {
    this.props.history.push(
      `/postlogin/selectbuyers/${this.props.match.params.id}`
    );
  };
                ...
                <div className="row align-items-end">
                  ...
                  <div className="col-xl-6 col-lg-6 col-md-4 col-sm-6 col-12">
                    <div className="creation-box">
                      ...
                      {requisitionData && requisitionData.createdOn && (
              ...
              buyersListTable.data.length > 0 && (
                <div className="buyers-list">
                  ...
                  <Table
                    ...
                    isLoading={
                      this.props.requisition_status === status.IN_PROGRESS
                    }
                    tableClasses={{
                      table: "ticket-tabel",
              ...
              {!buyersListTable.data ||
                (buyersListTable.data.length === 0 && (
                  <Button variant="contained" className="primary-btn">
                    <Link
                      to={`/postlogin/selectbuyers/${this.props.match.params.id}`}
                    >
                      Select Buyers
                    </Link>
                  </Button>
