...
class ViewRecievedRfq extends Component {
  ...
  componentDidMount() {
    this.props.dispatch(
      recievedrfpAction.getRecieveRFQ({ id: this.props.match.params.id })
    );
  }

  componentDidUpdate(prevProps, prevState) {
    if (
      prevProps.recieved_rfq_status !== this.props.recieved_rfq_status &&
      this.props.recieved_rfq_status === status.SUCCESS
    ) {
      this.setState({
    ...
    if (
      prevProps.create_recieved_rfq_status !==
        this.props.create_recieved_rfq_status &&
      this.props.create_recieved_rfq_status === status.SUCCESS
    ) {
  ...
  displayTableData = () => {
    ...
    if (
      recievedData &&
      recievedData.requistionItem &&
      recievedData.requistionItem.length > 0
    ) {
  ...
  addRecievedRFQ = (status) => {
    this.props.dispatch(
      recievedrfpAction.addRecieveRFQ({
            ...
            <div className="row">
              <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 mb-4">
                <div className="requisitioner-text">
                  ...
                  {recievedData.roleName && (
                    <span>{recievedData.roleName}</span>
                  )}
                </div>
              </div>
              <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 mb-4">
              ...
              <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 mb-4">
                <div className="requisitioner-text">
                  ...
                  {recievedData.currency && (
                    <span>{recievedData.currency.countryName}</span>
                  )}
                </div>
              </div>
              <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 mb-4">
            ...
            <div className="row">
              <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 mb-4">
                <div className="requisitioner-text">
                  ...
                  {recievedData.vendoreDetail &&
                    recievedData.vendoreDetail.name && (
                      <span>{recievedData.vendoreDetail.name}</span>
                    )}
                </div>
              </div>
              <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 mb-4">
                <div className="requisitioner-text">
                  ...
                  {recievedData.vendoreDetail &&
                    recievedData.vendoreDetail.email && (
                      <span> {recievedData.vendoreDetail.email}</span>
                    )}
                </div>
              </div>
              <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 mb-4">
                <div className="requisitioner-text">
                  ...
                  {recievedData.vendoreDetail &&
                    recievedData.vendoreDetail.nature && (
                      <span>{recievedData.vendoreDetail.nature}</span>
                    )}
                </div>
              </div>
              <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 mb-4">
                <div className="requisitioner-text">
                  <label>Location</label>
                  {recievedData.vendoreDetail &&
                    recievedData.vendoreDetail.location && (
                      <span>{recievedData.vendoreDetail.location}</span>
                    )}
                </div>
              </div>
              <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 mb-4">
                <div className="requisitioner-text">
                  ...
                  {recievedData.vendoreDetail &&
                    recievedData.vendoreDetail.relation && (
                      <span>{recievedData.vendoreDetail.relation}</span>
                    )}
                </div>
              </div>
              <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 mb-4">
                <div className="requisitioner-text">
                  ...
                  {recievedData.vendoreDetail &&
                    recievedData.vendoreDetail.phone && (
                      <span>{recievedData.vendoreDetail.phone}</span>
                    )}
                </div>
              </div>
            </div>
