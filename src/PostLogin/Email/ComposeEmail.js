          ...
          <div className="footer-bottom">
            <div className="footer-section-inner">
              ...
              <div className="symbols">
                <ul>
                  <li>
                    <IconButton className="symbols-icon">B</IconButton>
                  </li>
                  <li>
                    <IconButton className="symbols-icon">I</IconButton>
                  </li>
                  <li>
                    <IconButton className="symbols-icon">U</IconButton>
                  </li>
                  <li>
                    <IconButton className="symbols-icon">
                      <TagFacesIcon />
                    </IconButton>
                  </li>
                </ul>
...
export default withTranslation()(connect(null)(ComposeEmail));
