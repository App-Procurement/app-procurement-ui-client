...
function getPurchaseOrder(data) {
  ...
  return fetch(`${apiEndPoint.PURCHASEORDERS}/${data.id}`, requestOptions).then(
    (response) => response
  );
}
...
function searchPurchaseOrder(data) {
  ...
  return fetch(`${apiEndPoint.PURCHASEORDERS}`, requestOptions).then(
    (response) => response
  );
}
...
function approvePO(data) {
  ...
  return fetch(
    `${apiEndPoint.PURCHASEORDERS}/approve/${data.id}`,
    requestOptions
